...
IFontDisp = Font
__all__ = [ 'Default', 'OLE_HANDLE', 'OLE_XSIZE_PIXELS',
           'OLE_YSIZE_CONTAINER', 'FONTUNDERSCORE', 'Monochrome',
           'OLE_XPOS_CONTAINER', 'IFontDisp', 'OLE_YPOS_HIMETRIC',
           'OLE_ENABLEDEFAULTBOOL', 'IPicture', 'OLE_YPOS_CONTAINER',
           'VgaColor', 'FONTSTRIKETHROUGH', 'Gray', 'FONTSIZE',
           'OLE_XSIZE_HIMETRIC', 'OLE_OPTEXCLUSIVE', 'Checked',
           'IFont', 'StdPicture', 'OLE_TRISTATE', 'FONTNAME',
           'LoadPictureConstants', 'Picture', 'IPictureDisp',
           'OLE_COLOR', 'IFontEventsDisp', 'OLE_XPOS_HIMETRIC',
           'FONTBOLD', 'Color', 'Unchecked', 'FontEvents', 'Font',
           'OLE_XPOS_PIXELS', 'OLE_YSIZE_PIXELS', 'OLE_YPOS_PIXELS',
           'StdFont', 'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_CONTAINER',
           'FONTITALIC', 'OLE_CANCELBOOL']
from comtypes import _check_version; _check_version('1.1.9', 1523489644.254465)
